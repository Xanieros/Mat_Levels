...
Hover over an item and see what is the highest level that any crafter class uses the item. This recursively checks all recipes that use the mat as well as the recipes that use those recipes to find the highest level
